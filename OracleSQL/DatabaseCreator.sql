...
CREATE TABLE Moc (
    ...
    Nazwa varchar2(50)  NOT NULL,
    Przynaleznosc varchar2(50)  NOT NULL,
...
CREATE TABLE Planeta (
    ...
    Nazwa varchar2(50)  NOT NULL,
    Galaktyka varchar2(50)  NOT NULL,
...
CREATE TABLE Seria (
    ...
    Nazwa_serii varchar2(100)  NOT NULL,
...
CREATE TABLE Typ_mocy (
    ...
    Nazwa_zywiolu varchar2(50)  NOT NULL,
    Nazwa_drugorzednego_zywiolu varchar2(50)  NULL,
